...
<Image
  ...
  src="/img/plugins/business-variable/new-name.png"
  width="60%"
/>
:::
...
With the latest updates, users can [switch between dashboards](/plugins/business-variable/redirect), which adds to the satisfying user experience.
