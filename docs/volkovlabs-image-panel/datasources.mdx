...
You can use a [Business Input data source](/plugins/volkovlabs-static-datasource) to retrieve any supported Base64 formats and render them on your Grafana dashboard.
