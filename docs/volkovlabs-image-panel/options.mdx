...
## Business Image/PDF section

The Business Image/PDF section has the following parameters:
...
<Image
  title="Three parameters of the The Business Image/PDF section."
...
The Business Image/PDF Panel supports the toolbar starting from version 3.6.0.

The Business Image/PDF Panel supports image zooming starting from version 4.0.0.
