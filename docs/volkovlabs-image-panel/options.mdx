...
In this section, you can find descriptions of all existing plugin options.
...
The Business Media section has the following parameters:
...
<Image
  title="Three parameters of the Business Media section."
...
<Image
  title="The Business Media panel provides a toolbar to download, navigate between images, and zoom in/out or open in full screen."
