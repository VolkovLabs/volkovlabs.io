...
Base64 Image/Video/Audio/PDF Panel supports the toolbar since version 3.6.0.

Base64 Image/Video/Audio/PDF Panel supports the image zooming since version 4.0.0.
