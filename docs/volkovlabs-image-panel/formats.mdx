...
<Image
  title="Base64 panel renders images on Grafana dashboard."
...
<Image
  title="Base64 panel renders PDF files on Grafana dashboard."
  src="/img/plugins/volkovlabs-image-panel/pdf.png"
/>

## Video

The plugin renders video files with with the provided definition, as follows:
...
The plugin outputs audio video files with with the provided definition, as follows:
