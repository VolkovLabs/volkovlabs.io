...
<Tabs>
  <TabItem value="editing" label="Row Editing" default>
    Add, edit, and delete rows effortlessly starting with version 1.9.0.
  </TabItem>
  <TabItem value="thresholds" label="Grafana Thresholds">
    Visualize data limits with built-in threshold support (1.9.0+).
  </TabItem>
  <TabItem value="images" label="Image Display">
    Embed and display images within your tables (1.9.0+).
  </TabItem>
  <TabItem value="nested" label="Nested Objects">
    Manage complex data with nested object support (introduced in 1.5.0).
  </TabItem>
</Tabs>
