...
The **Date Time** type allows users to enter a value in the DateTime format using a standard Grafana component. Optionally, you can specify a range of permitted date-times using **Set Min Date** and **Set Max Date** parameters.
