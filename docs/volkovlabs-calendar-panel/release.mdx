---
description: Release Notes for Calendar Panel.
tags:
  - Calendar
  - Release Notes
...
- Increase the test coverage and updated the testing library (#100, #103).
...
Refactoring and styles migration may introduce breaking changes. Please test before upgrading the plugin on production Grafana instances.
...
- Added the new details view. Instead of relying on tooltips, this version uses an inline drawer to display additional details, although some minor limitations may still remain.
