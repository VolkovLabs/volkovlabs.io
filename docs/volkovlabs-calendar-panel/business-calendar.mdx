...
The **Business Calendar** section consists of two parameters at the moment:

<Image
  title="The Business Calendar section."
  src="/img/plugins/volkovlabs-calendar-panel/bus-calendar-section.png"
  width="40%"
/>
