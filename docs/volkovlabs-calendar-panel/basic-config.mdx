...
For the **Work** and **Month** layouts, the plugin considers the Grafana system settings when choosing the first day of the week - Saturday, Sunday, or Monday, or uses the default day from Grafana settings.

<Image
  title="You can specify the first day of the week in the user or organization preferences."
