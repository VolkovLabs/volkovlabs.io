...
To scale the content when the panel is resized use `echartsInstance` method to retrieve the width and height of the panel.
...
It's possible to add elements (button, checkbox, select, etc.) to the DOM (Document Object Model) using `echartsInstance`.
