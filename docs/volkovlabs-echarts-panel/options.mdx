...
| `context.editor.dataset`                                   | **[Visual mode]** Publish and subscribe to application events.                   |
| `context.editor.series`                                    | **[Visual mode]** Publish and subscribe to application events.                   |
