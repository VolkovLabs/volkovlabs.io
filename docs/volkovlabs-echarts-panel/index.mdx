...
The Business Charts Panel plugin is a visualization extension for Grafana powered by the [Apache ECharts library](https://echarts.apache.org/en/index.html)
...
- The [Apache ECharts library](https://echarts.apache.org/en/index.html) is a chart generation library.
- The Business Chart Panel plugin integrates the Apache ECharts library into the Grafana dashboard for building charts and graphs of different types.
