...
You can install Apache ECharts Panel from [Grafana Plugins catalog](https://grafana.com/grafana/plugins/volkovlabs-echarts-panel/) or using the Grafana command line tool.
...
- Based on [Apache ECharts 5.4.2](https://archive.apache.org/dist/echarts/5.4.2/).
