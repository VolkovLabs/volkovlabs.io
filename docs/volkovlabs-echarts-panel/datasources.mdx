...
<Video
  ...
  title="How to use Data Source in the Business Charts in 90 seconds."
/>
...
The wind speed visualization is one of the advanced examples of what the Busines Charts panel can do.
