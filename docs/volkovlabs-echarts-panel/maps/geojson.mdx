...
You can load additional GeoJSON maps dynamically using Data source.
...
JSON for Canada map. `https://raw.githubusercontent.com/codeforamerica/click_that_hood/master/public/data/canada.geojson`
