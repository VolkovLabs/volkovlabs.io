---
description: Release Notes for Apache ECharts Panel.
tags:
  - Apache ECharts
  - Release Notes
...
- Update the default function to support Grafana 10 (#178).
...
- Updated USA and World GeoJSON used in the GeoMap module (#154).
...
- Updated the README file and moved the product documentation to the [documentation site](https://volkolabs.io/plugins/) (#107).
...
- Added the Histograms, Clustering, Regression tutorial (#83).
...
- Updated CI to Node 16 and synchronize it with the release workflow (#65).
...
- Resolved the ussye with chart corruption after resetting the zoom (#13).
