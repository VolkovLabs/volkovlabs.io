...
Use the `replaceVariables()` function to replace Dashboard and Global variables. To learn about three types of variables take a look at [Variables](/plugins/grafana/variables).
