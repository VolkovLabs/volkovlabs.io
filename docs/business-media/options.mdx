...
In this category, you can find descriptions of all existing plugin options.
...
<Image
  title="Three parameters of the Business Media category."
  src="/img/plugins/business-media/community.png"
/>
...
The **Toolbar** category works for PDF and image files only.
...
Most browsers have a PDF toolbar by default. Using the **Toolbar** option category you can disable that default if needed.
...
<Image
  ...
  src="/img/plugins/business-media/zoom.png"
/>
