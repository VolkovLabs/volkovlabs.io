...
Since we added the external libraries feature along with the JavaScript functionality, the Dynamic Text plugin can not stop surprising us with its applicability. This article outlines the steps and demonstrates an example of how D3.js library can be incorporated into your Grafana dashboard.
