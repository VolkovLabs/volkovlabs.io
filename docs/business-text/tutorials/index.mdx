...
| ------------------ | ------------------ | -------------------------------- |
| HTML & Markdown    | 1.9.0              | Basic formatting and structuring |
| JavaScript         | 2.0.0              | Dynamic functionality            |
| External Libraries | 5.0.0              | D3.js and more                   |
| Anonymizer         | -                  | Demo data conversion             |
| Custom Datepicker  | -                  | Enhanced time range selection    |
