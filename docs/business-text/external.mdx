...
Be careful when using the example.
Plug-in libraries may change their versions and the code in the example may not work or may cause an error.
...
You should change the version of `https://esm.sh/plotly.js-dist-min@2.35.2`, or check the new version of the module and change the code.
...
[Example](/plugins/business-text/external/#example-with-different-versions)
:::
