...
| Section                          | Description                                                   |
| -------------------------------- | ------------------------------------------------------------- |
| [Base64 Image/PDF](panels/image) | Demonstrates how to use the data source with graph panels.    |
| [Logs](panels/logs)              | Demonstrates how to use the data source with image panels.    |
| [Node Graph](panels/graph)       | Demonstrates how to use the data source with logs panels.     |
