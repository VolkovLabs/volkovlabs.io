...
<Image
  title="Visualize wind speed with direction based on the data from the Static data source."
  src="https://github.com/volkovlabs/volkovlabs-static-datasource/raw/main/src/img/dark.png"
/>
