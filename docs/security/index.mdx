...
The [Business Input data source](/plugins/business-input/) includes a JavaScript Value Editor, which can be disabled in the data source options for added safety:
...
Business Suite Enterprise partners please open [Zendesk](https://support.volkovlabs.io) ticket for fast response.
