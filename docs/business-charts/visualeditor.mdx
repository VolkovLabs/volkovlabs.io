...
This feature is in the beta version. As of now, it should work for all charts mentioned in the **Type** dropdown. 

<Image
  title="The Type dropdown location."
  src="/img/plugins/business-charts/type-location.png"
/>
...
| ------------------------------------- | -------------------------------------------------|
| [Line](../visualeditor/#line)         | Provides examples for the **Line** chart type.   |
| [Bar](../visualeditor/#bar)           | Provides examples for the **Bar** chart type.   |
| [Radar](../visualeditor/#radar)       | Provides examples for the **Radar** chart type.   |
| [Sunburst](../visualeditor/#sunburst)         | Provides examples for the **Sunburst** chart type.   |
| [Boxplot](../visualeditor/#boxplot)         | Provides examples for the **Boxplot** chart type.   |
...
Then, ensure to configure the **Radar Options**:
