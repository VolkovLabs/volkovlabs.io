...
In addition, we are actively working on adding more JavaScript and Gafana parameters.
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `data`             | Data from data sources. The display of one or multiple data rows from the selected data frame or from all data frames is determined by the **Render template** option. It can be one of three values: **Every Row**/**All Rows**/**All data**|
| `panelData`        | |
