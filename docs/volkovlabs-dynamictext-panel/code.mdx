...
| `eventBus`         | Publish and subscribe to application events. Added in 4.0.0.                                                                |
...
Return unique values from `data` using Handlebars helper `unique` by community member [goncalobsantos](https://community.grafana.com/u/goncalobsantos).
