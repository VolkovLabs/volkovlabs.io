...
In the **JavaScript->before rendering content** option a user can register [custom handlebars](/plugins/volkovlabs-dynamictext-panel/code/#custom-handlebars-helper).
