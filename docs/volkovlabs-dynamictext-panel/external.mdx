...
External CSS/JS files can be used to add additional visual elements, JavaScript functions to execute from the [JavaScript Code](/plugins/volkovlabs-dynamictext-panel/code) editor.
