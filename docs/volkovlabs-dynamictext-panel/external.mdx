...
This is example based on example above and extend it with using dashboard variables and another approach to using `Leaflet.js` in the Dynamic Text Plugin.
