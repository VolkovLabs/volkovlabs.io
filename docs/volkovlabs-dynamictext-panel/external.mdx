...
Thank you [Raghavendra Samant](https://github.com/samant-rags) for exploring an Tailwind CSS.

Tailwind adds style and beauty to your panels. Applying Tailwind to Business Text is a little different from the previous examples.
...
Create a file and place it in public folder. `usr/share/grafana/public/yourFileName.js`

<Image
  title="Path with placed file"
  src="/img/plugins/volkovlabs-dynamictext-panel/file-path.png"
/>

File can contain the import function and use tailwind, or it can use code from `cdn.tailwindcss.com.`

Let's consider both variants

#### 1. CDN base code

Create a `tailwind.js` file and put the code from `cdn.tailwindcss.com.` into it. As example we use `https://cdn.tailwindcss.com/3.4.4`

<Image
  title="Tailwind file example"
...
#### 1. Function to load Tailwind from CDN

Create a `loadTailwindFromCDN.js` file and put the code below
