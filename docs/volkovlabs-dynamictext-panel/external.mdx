...
This idea comes from the [GitHub issue](https://github.com/VolkovLabs/volkovlabs-dynamictext-panel/issues/276) opened by [Josiah Solomon](https://github.com/yosiasz). The Dynamic Text plugin can be used to display Leaflet.js maps on your Grafana dashboard.
...
Below is an example of a dashboard displaying a leaflet.js maps
