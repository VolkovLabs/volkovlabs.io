...
To work with the query results as a whole, you can use [#each builtin helper](../recipes/#iterate-through-all-fields-in-each-record) to iterate over the records.
