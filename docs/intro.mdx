...
Most of our maintained plugins are available in the [Grafana Catalog](https://grafana.com/grafana/plugins/) and can be installed in Cloud and On-Premises.

## Private Repository

We are constantly updating and improving our Grafana plugins. A private repository has become a part of our workflow to verify and test plugins on our demo server and projects. Read more in the blog.

<a href="/blog/installing-grafana-plugins-from-a-private-repository-805b54a1add3">
  <Image
    title="Installing Grafana plugins from a Private repository"
    src="/img/blog/2022-03-14-private-repository/banner.png"
    zoom={false}
  />
</a>
