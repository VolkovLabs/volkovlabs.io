...
Thanks to community user [fercasjr](https://github.com/fercasjr) for examples.
...
The body's elements are coming from the plugin's form, that's why is inside the `${}` - `body.element_id1` is getting the `element_id1`
