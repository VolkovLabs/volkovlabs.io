...
You can find an example of the File type in the following article. There we demonstrate how Data Manipulation can interact with other plugins ([the Variable panel](/plugins/volkovlabs-variable-panel/) and [the Base64 panel](/plugins/business-media/)).
