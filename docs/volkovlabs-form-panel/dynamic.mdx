...
The `context.panel.onOptionsChange()` handler call the refresh panel. If you use it in initial request , don't forget to disable the Synchronize option.
...
<Image
  ...
  src="/img/plugins/volkovlabs-form-panel/infinity-reload.png"
/>
