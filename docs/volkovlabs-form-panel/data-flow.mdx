...
Find more information, tips and tricks in the other section of our [documentation](../architecture).
...
When this button is not hidden (any other mode is selected), you will also get the Reset Request section. There, you can go with either the Initial Request option or Custom code.
