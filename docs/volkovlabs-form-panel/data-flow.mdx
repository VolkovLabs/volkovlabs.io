...
Query editor and Frontend Data Source change payload use from version 4.0.0  
Query editor available from version 4.0.0
:::

Query editor allows to select an API request from existing in your data source ones.
