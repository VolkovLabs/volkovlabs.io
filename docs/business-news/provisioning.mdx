...
<Image
  ...
  src="/img/plugins/business-news/datasource.png"
/>
...
<Image
  ...
  src="/img/plugins/business-news/error.png"
/>
...
<Image
  title="Provided URL should be exactly as it returned from the RSS and Atom resource to avoid CORS policy restrictions."
  src="/img/plugins/business-news/correct-url.png"
/>
