...
The Business Variable Panel supports this feature starting from version 1.7.0.
...
<Image
  title="Example of the key-value variable format in the Busines Variable panel."
