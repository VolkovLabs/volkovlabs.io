...
<Image
  ...
  src="/img/plugins/volkovlabs-variable-panel/query-custom.png"
/>

In the minimized mode the variable panel allows updating (selecting another value) dashboard variables without occupying valuable top space since you can place it anywhere on the dashboard. In the example below, there are four Business Variable panels. They are located on the top right and provide a selection of Regions, Countries, States, and Markets. 
...
<Image
  ...
  src="/img/plugins/volkovlabs-variable-panel/multi.png"
/>
