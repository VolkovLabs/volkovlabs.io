...
This parameter has three options to choose from.

<Image
  title="Display Mode parameter for Variable panel."
  src="/img/plugins/volkovlabs-variable-panel/display-mode.png"
  width="70%"
/>

Select **Minimize** if you plan to have the native select look, but placed anywhere on your dashboard. You can review the example in the [Minimized Mode](../select/).
...
**Table** mode provides many more variations, from the simplest basic view to the most loaded TreeView.
