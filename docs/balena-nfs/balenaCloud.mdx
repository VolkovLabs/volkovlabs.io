...
<Image
  ...
  src="/img/projects/balena-nfs/env-nfsv3.png"
/>

## Balena Application

The [Balena Application](/plugins/volkovlabs-balena-app) for Grafana allows displaying the device information and managing services using Balena Supervisor API.
...
<Image
  ...
  src="/img/projects/balena-nfs/dashboard.png"
/>
