...
<Image
  title="Grafana management basics."
...
The `stocks` is a hyper-table. I created it as a regular and converted it into a hyper-table. The first parameter is a table name to convert, and the second is a column name with timestamp.
