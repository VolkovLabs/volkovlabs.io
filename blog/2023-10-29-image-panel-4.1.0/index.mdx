...
# Business Image/PDF Panel 4.1.0

We are excited to announce the release of the Business Image/PDF Panel 4.1.0. This major release includes the following updates:
