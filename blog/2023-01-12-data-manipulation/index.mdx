...
<Code
  url="https://github.com/VolkovLabs/business-forms/blob/main/server-deno/server.ts"
  language="js"
/>
...
Data Manipulation Panel, like Grafana itself, was designed to embrace [flexibility](/plugins/business-forms/code). You can get started with static forms and progress to dynamic ones.
...
Data Manipulation Panel is a brand-new Grafana plugin. It is the first plugin that allows you to insert and update application data, as well as modify settings, straight from your Grafana dashboard. You can find more details about it in our [product documentation](/plugins/business-forms/).
