...
authors:
  - name: Alexey Smolyanyy
    ...
    title: Director of Customer Success Strategy and Operations, Redis LLC
...
They just return the respective amount of ARR already successfully closed or lost since the beginning of the renewal period until now. I'd like to highlight: it uses the new Grafana transformation “Config from query results” to dynamically calculate target ARR to proper display thresholds on gauges.
