...
This feature is applicable when your Variable panel used in Minimized and Button layout. This mode could be turned on and off in the Variable panel options.
