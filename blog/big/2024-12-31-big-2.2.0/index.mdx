...
The timeline of alerting states is a subset of all alert rule records and includes only instances where alerting state changes. We added Engine API endpoint to [get timeline of alerting states](https://volkovlabs.io/big/api/#tag/Alert-Rules/operation/AlertsController_getHistoryTimeline).
