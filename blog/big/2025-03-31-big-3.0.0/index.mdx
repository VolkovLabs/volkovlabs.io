...
If no data is returned, specify what [status](https://volkovlabs.io/big/alerting/manage-alert-rules/#flow-schema) the alert should change into. The choices are:
