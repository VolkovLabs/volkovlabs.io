...
We strive to achieve a high performance in business intelligence. The revised approach to cluster load balancing is one of the things that helps the cause. In this release, we worked on better alert balancing between connected Buinsess engines. 
