...
- The [Getting Started](/big/getting-started/) guide provides a full Docker-based solution.
- Process: Download the container package and configure each component with step-by-step instructions.

<Image
  title="Getting Started solution overview."
