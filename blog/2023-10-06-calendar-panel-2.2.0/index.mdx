...
In the Event category, a new <b>Location</b> parameter is available for Big Calendar type only.
...
In the Calendar category, for the Views parameter, we added a new option <b>work week</b>. The setting is similar to a week view, but instead of seven days, it displays 5 days and hides Saturdays and Sundays.
