...
# Business Image/PDF Panel 3.4.0

We are excited to announce the release of the Business Image/PDF Panel 3.4.0. This maintenance release includes the following updates:
