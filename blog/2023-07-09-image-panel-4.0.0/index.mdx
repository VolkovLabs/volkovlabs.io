...
# Business Image/PDF Panel 4.0.0

We are excited to announce the release of the Business Image/PDF Panel 4.0.0. This major release includes the following updates:
...
<Shorts
  ...
  title="Business Image/PDF Panel 4.0.0 for Grafana."
/>
