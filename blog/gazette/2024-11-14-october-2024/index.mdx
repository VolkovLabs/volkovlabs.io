...
# Business Gazette: Grafana 11.3, nested objects in the Business Table panel, and 3,600 YouTube subscribers
...
The [scenes dashboards in Grafana 11.3 release](https://grafana.com/blog/2024/10/31/grafana-dashboards-are-now-powered-by-scenes-big-changes-same-ui/) introduced some breaking changes for our plugins. We thank the Grafana engineering team for the timely collaboration in solving all issues.

For more details, refer to this [GitHub issue](https://github.com/grafana/grafana/pull/93327).

Following the fix, we implemented [all necessary changes](https://github.com/grafana/grafana/issues/94479) to ensure our plugins are up and running in Grafana 11.3

Currently, 6 of the Volkov Labs plugins have migrated to the latest Grafana 11.3 release. The rest will follow suit according to the individual release schedule.
...
Even expecting better activity in September-October, we are hit by a surprise to get more than 3,600 subscribers in total on our YouTube channel. I am happy to share this fantastic news with our readers.
