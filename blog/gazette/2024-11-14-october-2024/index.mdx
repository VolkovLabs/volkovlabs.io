...
- released
- scenes dashboards with breaking changes
- we were working with Grafana team to restore functionality
- https://github.com/grafana/grafana/pull/93327 was solved by Grafana in the latest Grafana 11.3
- https://github.com/grafana/grafana/issues/94479 was updated in our plugins

Half of the plugins were updated to the latest Grafana 11.3 and half will be updated followwing their release cycle.
