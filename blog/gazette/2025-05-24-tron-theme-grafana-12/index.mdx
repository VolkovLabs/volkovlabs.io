...
tags: [Business Gazette, Grafana Crash Course]
...
<Image
  title="Theia Scientific dashboard featuring the Business Table panel with Tron theme."
...
2. **Install Business Suite Plugins**:
   ...
   - Add our plugins via the [Grafana Plugins Catalog](https://grafana.com/grafana/plugins/).
...
<Image
  title="Prometheus Metrics with Tron theme."
  src="/img/blog/2025-05-24-tron-theme-grafana-12/engine.png"
/>
