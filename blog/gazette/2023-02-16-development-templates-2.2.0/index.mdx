...
tags: [Business Gazette, Development]
...
:::info Archived
Since publishing this blog the templates were archived. We recommend to use [Plugin Tools](https://grafana.com/developers/plugin-tools/) to create new plugins.
:::
