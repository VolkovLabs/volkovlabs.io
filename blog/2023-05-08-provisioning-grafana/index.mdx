...
tags: [Getting Started, Provisioning]
...
<Image
  title="Provisioning is one of the way to move changes from Development to Production environment."
...
<Image
  title="File sample.yaml is an example for how to provision dashboards."
