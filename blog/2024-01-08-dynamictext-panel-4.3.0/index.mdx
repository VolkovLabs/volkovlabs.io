...
Override Dynammic Text default table styles to display table on the server.
...
I got it from Josiah, screenshot in the Slack. Example from <a href="https://d3-graph-gallery.com/graph/heatmap_style.html">Heatmap Example</a>.
