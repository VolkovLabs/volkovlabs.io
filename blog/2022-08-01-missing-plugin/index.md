...
The Apache ECharts panel was recently submitted to the Grafana Catalog. Meanwhile, it can be installed manually from our [Private Repository](/plugins/intro) or [downloaded directly from GitHub](https://github.com/volkovlabs/volkovlabs-echarts-panel).
