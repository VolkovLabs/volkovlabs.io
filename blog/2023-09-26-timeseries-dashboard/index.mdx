...
For more information on how such a system can be set up, please, refer to the external resource:
[Node Exporter](https://prometheus.io/docs/guides/node-exporter/).

## Variable panel

I started my dashboard by configuring a filtering functionality. To be more user-friendly, I wanted to position my filter on the same horizontal level as my TimeSeries. 

There is only one Grafana plugin as of this moment that allows achieving such a requirement. It is the Variable panel.

<Image
  title="Variable panel to select servers for display."
  src="/img/blog/2023-09-26-timeseries-dashboard/dash.png"
/>

### Panels' Datasource

All panels have the same data source to read data from. The data source is configured as a dashboard variable that a user can select in the Variable panel.
...
<Image
  title="Repeat option in Time Series."
  src="/img/blog/2023-09-26-timeseries-dashboard/repeat.png"
/>

### Panels Visualization Options
...
I already mentioned everything I changed in the <b>Panel options</b> section, namely, dynamic title and Repeat options. 

For the rest, I touched upon <b>Graph styles</b> and <b>Standard option</b> sections to set the fill opacity, gradient mode, and units.
...
This dashboard builds four time series for each selected server. 
- CPU Usage
- Load Average
- Memory Usage
- Disk Space
...
If you have any questions about this article, please, do not hesitate to leave them in the comments section under the YouTube video I mentioned at the beginning. 
