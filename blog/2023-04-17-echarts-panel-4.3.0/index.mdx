...
We added support for Annotations in Apache ECharts using mark lines. Data for mark lines is retrieved from the `context.panel.data.annotations` object as explained in the [product documentation](/plugins/volkovlabs-echarts-panel/annotations/).
...
<Video
  ...
  title="Dynamic Text, Data Manipulation and Business Charts plugins."
/>
