...
In most cases, you won't need to update the Default Content or use JavaScript Code and Styles. We love the minimalistic design with only the Content editor displayed and I hope you will love it.

## Styles editor

You can add custom styles or override the defaults using the dedicated code editor with CSS syntax highlight.
...
The code syntax highlighting is based on the `highlight.js` library, which supports major languages.
...
- Add option to display required editors (#149)
