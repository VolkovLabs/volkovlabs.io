...
We are impressed with the everyday creations from the community using the latest features in the Dynamic Text panel for Grafana. One of the interesting use cases is creating tabs with styles, JavaScript Code, and a mix of Handlebars with HTML.

Previously it can be possible only with custom panels.
