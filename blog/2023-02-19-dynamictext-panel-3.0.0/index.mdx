...
:::info
Release submitted to Grafana team for review. Meanwhile, can be downloaded from the [GitHub repository](https://github.com/VolkovLabs/volkovlabs-dynamictext-panel/releases).
:::
