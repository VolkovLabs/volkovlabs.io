...
You can install Business Media Panel from the command line or directly in the Grafana Cloud with the `grafana-cli` tool.
...
<Image
  title="Business Media panel displays an image using the static data source."
