...
Country Heatmap is not supported in the GeoMap, and we used the [Business Charts panel](/plugins/business-charts/) instead. In the following video, we demonstrated how we did it.
