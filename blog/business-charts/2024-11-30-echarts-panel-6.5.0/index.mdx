...
# Autosize Code Editor, Scatter, Box visual editor, and Grafana 11.3 Scenes updates in Business Charts 6.5.0

We are happy to announce the release of the Business Charts panel 6.5.0. This release includes the following updates:

- Updated Autosize Code Editor.
- Added Scatter and Boxplot in Visual Editor.
