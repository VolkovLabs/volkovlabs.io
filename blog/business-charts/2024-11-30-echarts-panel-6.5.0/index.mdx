...
We started decoupling its core part from the embedded libraries to make the Business Charts panel more flexible and lightweight. As of this release, all libraries are still part of the Business Charts panel. However, we are getting ready for a complete split.
...
The syntax is identical to the [Business Text import functionality](https://volkovlabs.io/plugins/business-text/external/).
...
You can review the above example in our [sandbox project](https://echarts.volkovlabs.io).
