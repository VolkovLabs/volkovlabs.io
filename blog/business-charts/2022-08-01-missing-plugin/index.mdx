...
You can install Business Charts panel from the Grafana Plugins catalog (Plugins Configuration menu). Alternatively, you can set up it manually by [downloading from GitHub](https://github.com/volkovlabs/business-charts).
