...
In this release, we added more parameters for the Bar, Sunburst, and Radar types. The best way to learn what is available now is to review the updated examples at https://echarts.volkovlabs.io
