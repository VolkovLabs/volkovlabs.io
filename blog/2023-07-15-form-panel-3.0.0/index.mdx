...
<table>
  <tr style={{ border: "none" }}>
    <td style={{ border: "none", "vertical-align": "top" }}>
      <ul>
        <li>Added a hidden option to the String inputs.</li>
        <li>Added `notifyWarning` function for warnings.</li>
        <li>Added drag-and-drop support for the elements editor.</li>
        <li>Added vertical layout orientation.</li>
        <li>Updated form elements to delay save changes with auto-save.</li>
        <li>
          Updated form elements to use local state instead of saving values in
          the dashboard.
        </li>
        <li>Updated to Grafana 10.0.0 and removed Grafana 8.5 support.</li>
        <li>Requires Grafana 9 and Grafana 10.</li>
        <li>Migrated to Plugin Tools 1.5.2 with Node 18 and npm.</li>
        <li>Increased Test coverage to 97%.</li>
      </ul>
    </td>
    <td style={{ border: "none" }}>
      <iframe
        ...
        title="Data Manipulation 3.0.0 for Grafana."
        frameborder="0"
