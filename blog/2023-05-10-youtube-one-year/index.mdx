...
<Youtube
  title="Business Charts panel for Grafana. How to create modern dashboards in Grafana."
  id="DxqCrBEmrQw"
/>
...
<Youtube title="How to display the unemployment rate." id="B4Uj1n4Cr88" />
...
Subscribe to our [YouTube channel](https://www.youtube.com/@volkovlabs) and add a comment to ask questions.
