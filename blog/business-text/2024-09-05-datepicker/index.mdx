...
# Custom `Datepicker` to set time range in Grafana 11
...
:::info Grafana 10 and 11
Shoutout to Vitali Pinchuk for updating the original post for Grafana 11 and the latest version of Business Text plugin.
:::
