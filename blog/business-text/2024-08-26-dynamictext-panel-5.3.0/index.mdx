...
In addition to external CSS files and JavaScript libraries, starting from this release, you can use external [handlebars partials](https://handlebarsjs.com/guide/partials.html).
