...
tags: [Business Text, Business Gazette, Community]
...
[Plotly 3D Scatter](/plugins/business-text/external/plotly),
[Mermaid](/plugins/business-text/external/mermaid),
[Chart.js](/plugins/business-text/external/chart-js), and
...
In Grafana 11, the functionality of external JavaScript resources is deprecated, we removed the **External Resource**->**Scripts** parameter. You can import the JavaScript library directly in the code.
