...
https://community.grafana.com/t/display-base64-live-image-from-mqtt-datasource/127028
:::
...
The approach with MQTT is very similar to the WebSocket. 
Thank you [peltiern](https://community.grafana.com/u/peltiern/summary), Grafana community member, for the provided example of the publisher code. It streams data to the MQTT data source.

I tested it, it worked for us.
...
Below is the Business Media panel configuration to work with the MQTT data source.
...
Again, thank you [peltiern](https://community.grafana.com/u/peltiern/summary), Grafana community member, for the provided example of the dashboard displaying image streaming on the Grafana dashboard.

He also has two more visualizations for some other purposes. 
