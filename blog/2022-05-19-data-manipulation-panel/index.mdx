...
Our community had been insistently requesting this solution from us, so one day we decided to make it open-source and submitted it for evaluation to the Grafana team for inclusion into the Grafana Plugins catalog.
