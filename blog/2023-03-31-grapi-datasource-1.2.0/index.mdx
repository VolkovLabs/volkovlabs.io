...
tags: [Grafana HTTP API Data Source, Business Suite]
...
The Grafana HTTP API Data Source can be used together with [Business Calendar panel](/plugins/volkovlabs-calendar-panel) to visualize alerts that happened in a week or month.
