...
keywords: [Volkov Labs, Highlights, 2023]
---
...
The 2023 year was filled with many intriguing, inspiring, and even jaw-dropping events for us at Volkov Labs. 

In this article, I wanted to share the highlights of 2023 and why we are excited for 2024!

Let's go!

## Our YouTube channel reached the mark of 2000 subscribers
...
<Image
  title="Volkov Labs subscriber growth in 2023."
...
<Image
  title="Mikhail and Daria on the stage of Grafana ObservabilityCon in London."
...
In addition, Grafana added [our video](https://grafana.com/story-of-grafana/?plcmt=learn-nav) to their **Community, Innovation, Fun** page.

<Image
  title="Grafana added our videos into the Community, Innovation, Fun page."
  src="/img/blog/2023-12-22-top-of-2023/fun.png"
/>

## Grafana Documentary

In Stockholm, Sweden, Mikhail was filmed for the second episode of [the 10th-anniversary documentaries](https://www.youtube.com/watch?v=lbBQk_QPnEs), where many people mentioned our beloved Apache Echarts panel as their favorite Community plugin. 
...
<Image
  title="Welcome, Alex!"
  src="/img/blog/2023-12-22-top-of-2023/team.png"
/>
...
The idea of the BIG was born from a bare necessity to simplify everyday work for data analysts and project managers with profound expertise in their subject area but not in the Grafana. 
...
I even created a series for developers where I built a plugin demonstrating every step. Any JavaScript Developer can follow my lead and create their first Grafana plugin! 
...
That takes time, intelligent scheduling, quick wit, and deep knowledge to keep all our plugins compatible with the latest Grafana versions **all the time**. We are proud to be able to keep up and ensure the best results for our users. 
