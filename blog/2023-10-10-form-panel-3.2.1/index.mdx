...
- Added min and max date limit for the date time element.
- Added a limpid field mapping for the <b>Data Source</b> Initial Request type.
- Added a limpid field mapping for the <b>Query</b> Initial Request type.
...
<Image
  title="Impose min and max for the Date Time type."
  src="/img/blog/2023-10-10-form-panel-3.2.1/min-max.png"
/>

## Data Source Field Mapping

Following many community requests, we made field-to-form element mapping for the <b>Data Source</b> initial request type more straightforward. Now you can do it using a new parameter that appears for every form element when the <b>Data Source</b> initial request type is selected.

<Image
  title="Explicitly specify the field-to-form element mapping using a new parameter."
  src="/img/blog/2023-10-10-form-panel-3.2.1/field-name-ds.png"
/>

## Query Field Mapping

Following many community requests, we made field-to-form element mapping for the <b>Query</b> initial request type more straightforward. Now you can do it using a new parameter that appears for every form element when the <b>Query</b> initial request type is selected.
...
- For the Initial request, the end user will see a running blue line at the top of the form.
...
- For the Update request, all buttons are disabled and moving circled dots are placed instead of the Submit button icon.
