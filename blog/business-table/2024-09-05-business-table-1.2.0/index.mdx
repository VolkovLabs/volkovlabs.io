...
Below is an example of the displayed data change in the Business Table following the dashboard variable update.

<Image
  title="The Client filtering feature of the Business Table panel."
  src="/img/blog/2024-09-05-business-table-1.2.0/filtering-query-gif.gif"
/>
