...
As part of our [Business Suite](https://volkovlabs.io/plugins), this plugin plays nicely with companions like [Business Alerting](/big/alerting/), [Business Charts](/docs/business-charts/) and [Business Variable](/docs/business-variable/) and others. Pair it with real-time alerts or sleek visualizations, and you’ve got a full Business Intelligence platform in Grafana.
