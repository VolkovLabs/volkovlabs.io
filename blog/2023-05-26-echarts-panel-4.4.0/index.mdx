...
Apache ECharts Panel can solve any visualization challenges reported by our community. When native plugins lack some fetures or a data source cannot return or transform data in the required format, Apache ECharts Panel let you address any appeared challenges and achieve the results you anticipate.

We have addressed most critical issues in our GitHub repository as we expect an increasing number of daily downloads on our way to 200k downloads the Grafana Plugins catalog.
...
One of the three plugins that completes Grafana is Apache ECharts Panel. With Dynamic Text, Data Manipulation, and Apache ECharts Panel create fully functional web applications meeting your needs and expectations.
