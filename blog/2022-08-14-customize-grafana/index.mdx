...
To update the name of the Main Organization, update the binary file `grafana-server`. It's compiled file and the new name should be exactly 9 letters to avoid memory overflow issues.
