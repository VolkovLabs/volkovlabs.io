...
<Catalog date="October 18, 2023" />

<Shorts id="ghaFZ3ts3kk" title="Business Variable panel 2.0.0 for Grafana." />
...
For this feature to work, you must enable the <b>Empty Value</b> parameter in the Variable category.
