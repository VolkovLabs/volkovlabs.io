...
The following dashboard is a ready-to-go example that can be imported into Grafana as JSON. It requires the [Static data source](/plugins/volkovlabs-static-datasource/) and Apache ECharts visualization panel plugin.
