...
- Documentation and examples were updated and moved to our [documentation](https://volkovlabs.io/plugins/business-charts/) and [Plugin Examples](https://echarts.volkovlabs.io).
