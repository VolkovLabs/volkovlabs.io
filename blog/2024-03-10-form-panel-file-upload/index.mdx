...
1.  [The Business Forms panel](/plugins/volkovlabs-form-panel/) configured with the HTTP API server to upload files in the Base64 format.
2.  [The Business Forms panel](/plugins/volkovlabs-form-panel/) configured with Data Source to upload files in the Base64 format.
3.  [The Business Variable panel](/plugins/volkovlabs-variable-panel/) is configured to provide a selection of all upload files.
