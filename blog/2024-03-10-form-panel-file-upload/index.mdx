...
tags: [Data Manipulation, Base64 Image/Video/Audio/PDF, Variables]
...
1.  [The Data Manipulation panel](/plugins/volkovlabs-form-panel/) configured with the HTTP API server to upload files in the Base64 format.
2.  [The Data Manipulation panel](/plugins/volkovlabs-form-panel/) configured with Data Source to upload files in the Base64 format.
3.  [The Variable panel](/plugins/volkovlabs-variable-panel/) is configured to provide a selection of all upload files.
4.  [The Base64 panel](/plugins/volkovlabs-image-panel/) displays the selected on the Variable panel file.
...
Working dashboard example is available in the [GitHub repository](https://github.com/VolkovLabs/volkovlabs-form-panel/blob/main/provisioning/dashboards/files.json).
