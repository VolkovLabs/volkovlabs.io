...
This article provides an example of how the [Infinity data source](https://grafana.com/grafana/plugins/yesoreyeram-infinity-datasource/) can be integrated with the [Business Forms](/plugins/volkovlabs-form-panel/) plugin on the Grafana dashboard.
