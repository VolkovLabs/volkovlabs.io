...
The provided solution involving the Time Series panel and Shared Crosshair functionality is just one example of panels' interconnectivity. Panels can interact in various ways.
...
Now let's review how to display a shared crosshair on community panels, or, in other words, how to faciliate one of the possible ways of the panels' interconnectivities. I will use the [Business Charts panel](/plugins/volkovlabs-echarts-panel/) as an example of a Community plugin.
...
In this article we provided examples how to use one type of the events supported in EventBus. Full list of events you can find in the [Grafana Crash Course](/grafana/developer/eventbus/).
