...
Our plugin was designed to support small and medium-sized PDF documents that you can easily test without setting up a separate database for storage. For this purpose, we have used the [Business Input data source](/plugins/volkovlabs-static-datasource/) and stored the data in the dashboard.
