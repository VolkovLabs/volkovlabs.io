...
- Added the Button dispaly mode.
- Added group selection for the Tree View layout (beta).
- Added support of the Grafana key-value variable format.
...
:::info
This parameter is still under development and now is availabe in Beta version. Try it out with care. 
:::
...
<Image
  title="With a new parameter, 'Allow group selection'(beta), the selection of a group automatically selects all elements in this group."
...
Starting from this release, the variable panel supports this feature.
