...
In this weekend's project, we collected and visualized the content metrics for our website. Who, What, and from Where requested resources from the blog and documentation. To achieve this goal, we configured Nginx, Loki, Promtail to work together and show all required metrics on a Grafana dashboard.
  ...
  - job_name: nginx
    ...
    pipeline_stages:
      ...
      - drop:
          ...
          expression: "(bot|Bot|RSS|Crawler|Inspect|test)"
      - drop:
          source: request_uri
...
<Image
  title="Content metrics for the content requests."
...
<Image
  title="Technical metrics for the content requests."
...
The third part of the dashboard contains heatmaps, which helps to understand when and from where resources were requested in the selected Time Range.

<Image
  title="Heatmap of the content requests."
  src="/img/blog/2023-01-29-nginx-loki-grafana/heatmap.png"
/>

- Country displays requests per country.
- Requested pages displays requests per resource.
