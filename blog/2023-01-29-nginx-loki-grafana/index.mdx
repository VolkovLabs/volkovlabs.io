...
<Image
  title="Business Charts panel displays requests per country."
  src="/img/blog/2023-01-29-nginx-loki-grafana/echarts.png"
/>

Country Heatmap is not supported in the GeoMap, and we used the [Business Charts panel](/plugins/volkovlabs-echarts-panel) instead. In the following video, we demonstrated how we did it.
