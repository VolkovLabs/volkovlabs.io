...
<table>
  <tr style={{ border: "none" }}>
    <td style={{ border: "none", "vertical-align": "top" }}>
      <ul>
        <li>Added sticky header.</li>
        <li>Added auto-scroll for multi-group selection.</li>
        <li>Added drag and drop for tree view groups.</li>
        <li>Added expand and collapse all in the header.</li>
      </ul>
    </td>
