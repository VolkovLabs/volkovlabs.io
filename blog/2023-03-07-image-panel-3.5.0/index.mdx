...
# Business Image/PDF Panel 3.5.0

We are excited to announce the release of the Business Image/PDF Panel 3.5.0. This maintenance release includes the following updates:
...
Business Image/PDF Panel works with any data source. You can also use it with the MQTT data source to display the live camera feed.
