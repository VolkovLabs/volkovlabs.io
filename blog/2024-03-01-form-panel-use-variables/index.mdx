...
# Using variables in Data Manipulation
...
Configure needed variables which will be used later in Data Manipulation panel: facility, room and bench. Static datasource is used in the example.
...
<Image
  ...
  src="/img/blog/2024-03-01-form-panel-use-variables/variables.png"
/>
...
<Image
  ...
  src="/img/blog/2024-03-01-form-panel-use-variables/form-elements.png"
/>
...
Create panel queries with Static Datasource for all dynamic options. Usually, it should equal to the variable query.
<Image
  title="Facility options data."
  src="/img/blog/2024-03-01-form-panel-use-variables/facility-options-query.png"
/>

Next, need to set appropriated fields to the form elements
<Image
  title="Use options from query."
  src="/img/blog/2024-03-01-form-panel-use-variables/query-options-source.png"
/>

Since now, the form elements have options which is retrieved from panel data.
<Image
  title="Query data options."
  src="/img/blog/2024-03-01-form-panel-use-variables/query-options-example.png"
/>
...
<Image
  ...
  src="/img/blog/2024-03-01-form-panel-use-variables/initial-values.png"
/>
...
<Image
  ...
  src="/img/blog/2024-03-01-form-panel-use-variables/query-initial-action.png"
/>
...
<Image
  ...
  src="/img/blog/2024-03-01-form-panel-use-variables/element-query-field.png"
/>

Since now, if variable is updated, the value will be pre-populated to the form.
<Image
  title="Initial values from variable values."
  src="/img/blog/2024-03-01-form-panel-use-variables/initial-values-example.png"
/>

### Update variables from Data Manipulation panel
...
Enablement of submit button depends on if current values are different from initial.
...
<Image
  ...
  src="/img/blog/2024-03-01-form-panel-use-variables/enable-update-manual.png"
/>
...
Working dashboard example are available in [Dashboard JSON or Live example](https://github.com/VolkovLabs/volkovlabs-form-panel/blob/38ac8ea141a7be749db9bc748d1e2dd44b751c33/provisioning/dashboards/variables.json)
