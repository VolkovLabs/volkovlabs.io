...
The [Environment Data Source 2.0.0](/grafana/volkovlabs-env-datasource/release) supports Grafana 8.5+. For older versions of Grafana, please use version 1.2.0.
