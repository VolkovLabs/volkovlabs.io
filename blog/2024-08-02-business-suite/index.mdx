...
tags: [Business Suite, Volkov Labs]
...
- [Business News data source](/blog/business-suite-20240802/#business-news) to visualize RSS/Atom feeds.
...
- [Business Calendar panel](/blog/business-suite-20240802/#business-calendar) to display events and change time range.
...
We are open to new suggestions. Please [open a feature request](https://github.com/VolkovLabs/volkovlabs-grapi-datasource/issues) if your task requires working with something else.
...
Among many beloved cases that this panel solves with ease is [dashboard redirect](/plugins/volkovlabs-variable-panel/redirect/). This feature allows the corresponding dashboard to be opened to a variable value. It is useful, for instance, if a variable panel displays a list of some devices where every device requires a specific dashboard.
