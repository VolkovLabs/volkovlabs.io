...
- With the [Business Forms plugin](/plugins/business-forms/), instead of just visualization, you can manage your data and even system behavior. If with the original design, a user was seen as a silent, opinionless reader then now with a Business Forms panel, a user is promoted to Mission Control Center commander.
