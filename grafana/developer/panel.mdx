...
- Step 21. Unit and end-to-end test
- Step 22. Signing a plugin to make it a part of the Grafana catalog
- Step 23. Release
- Step 24. Variables
- Step 25. Bonus, adding a custom editor for panel options