...
Conventionally those variables are off-limits, but with the [Environment data source](/grafana/environment/), access to the environment variables is possible!
