...
# Building Your Business Dashboard in Grafana
...
One of our most-watched YouTube tutorials, this video walks you through creating a Grafana dashboard from scratch. Daria breaks down key panels—`bar chart`, `bar gauge`, `single stat`, `base64`, `pdf`, and `Geomap`—with step-by-step instructions. Filmed in May 2022 using Grafana 8, it’s perfect for newcomers.
