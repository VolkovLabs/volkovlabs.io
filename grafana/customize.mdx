...
If you ever wondered how to use your own icons and other style elements in the Grafana application, you came to the right corner of the Internet to find answers. 
...
The next important piece of information is the list of actual commands. Just scroll down a bit to find a Docker file. 
We keep it up to date with our latest findings. 
...
At this moment we have two related blog posts. The first one was written last summer and updated following the video above. In the "Spring cleaning" we go into details of the 'Cleaning' category. The idea that unnesesary parts can be removed from the Grafana instalaltion package seemed worthy a separate article.
