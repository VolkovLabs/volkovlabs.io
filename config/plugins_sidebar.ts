      ...
      items: [
        ...
        },
        {
          items: [
            ...
            "business-text/solution-bootstrap",
            "business-text/solution-chart.js",
            "business-text/solution-d3",
            "business-text/solution-flowchart",
            "business-text/solution-leaflet",
            "business-text/solution-mapbox-gl",
            "business-text/solution-mermaid",
            "business-text/solution-plotly",
            "business-text/solution-tailwind",
            "business-text/solution-tensorflow",
            "business-text/solution-youtube",
          ],
          label: "Rendering",
          type: "category",
          link: {
