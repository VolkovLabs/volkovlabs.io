        ...
        <div className="row">
          ...
          <div className="col col--4 text--center">
            <ThemedImage
              ...
              sources={{
                light: useBaseUrl("/img/big/eula.svg"),
                dark: useBaseUrl("/img/big/eula.dark.svg"),
              }}
              height={"65%"}
    ...
    <main>
      <div id="EULA" className="container margin-vert--md">
        <p>
          ...
          downloading or using Business Intelligence for Grafana.
        </p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              by the Company downloaded by You to a Device, named Business
        ...
        <p>
          ...
          the terms of this Agreement, do not download or do not use the
          Application.
        </p>
        <p>
