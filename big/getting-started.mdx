...
The Business Intelligence platform utilizes Docker containers to be modular and scalable. In this section, we describe one possible solution to demonstrate how you can get started, what the parts from the Business Intelligence are, and what other parts you might need. 

Feel free to follow the steps to arrive at the same solution in your environment. From there, you can adjust as needed. 
...
<Image
  title="One of the possible ways to download the configuration for the Business Intelligence example solution."
