...
8. Download and start the Business Studio from [Release Notes](../release)

## Work with the platform

### Business Studio

9. Configure Actions and Alert Rules
...
<Image
  ...
  src="/img/big/3-dashdboards.png"
/>

- **Business Engine** dashboard. It containes business engine metrics collected by Prometheus.

<Image
  title="Grafana dashboard displays Business Engine metrics collected by and stored in Prometheus."
