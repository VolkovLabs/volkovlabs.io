...
<Image title="Create a token." src="/img/big/token.png" />
...
<Image title="Alerts analysis." src="/img/big/alerts.png" />
...
<Image title="Requests analysis." src="/img/big/requests.png" />
...
<Image title="Processes analysis." src="/img/big/processes.png" />
...
<Image title="Test dashboard." src="/img/big/test-dash.png" />
