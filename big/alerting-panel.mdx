...
- The alert **evaluation** could be set to **Thresholds** or **Regex Pattern**. 
    - Ror the **Thresholds**, the alert examines the thresholds set for the specified dashboard/panel.
...
This tab lists all configured webhooks. In the edit mode, you specify a title, type (HTTP or Test), request URL and request method. For now, only POST is available.
...
<Image
  ...
  src="/img/big/web-hooks-panel.png"
/>
