...
- **Details**. Opens the drawer with the alert details. For the alert rules in the **Alerting** and **Error** statuses, the BI App also adds the **Event Details** category with all necessary information for troubleshooting.
