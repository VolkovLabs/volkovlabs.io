...
:::info Public Preview
The Business Intelligence platform is actively being developed. Public Preview releases are intended solely for testing and evaluation.
:::
...
- **[User-Friendly Business Studio](/big/studio)**
  - Simplifies Business Engine management for non-technical users, enhancing configuration and monitoring efficiency
- **[High-Performance Business Engine](/big/engine)**
  - Ensures reliable performance through distributed load balancing and high availability, tightly integrated with Grafana
- **[Advanced Business Alerts](/big/alerting)**
  - Offers customizable, query-based alerts with threshold and variable support for actionable insights

## Subscription

Business Intelligence operates on a [subscription model](/pricing/). A Community edition is available for small-scale projects, capped at 10 Business Alerts and a single Business Engine cluster.
