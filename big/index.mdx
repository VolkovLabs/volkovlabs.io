...
- Users. The Business Studio interface accommodates two types of users - **Business** and **Technical**. You can always switch between the two types by clicking one button (the feature is coming soon). 
