...
- MacOS:
  - [Apple Disk Image arm64](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-2.2.0-arm64.dmg)
  - [Apple Disk Image x86](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-2.2.0-x64.dmg)
  - [ZIP file arm64](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-darwin-arm64-2.2.0.zip)
  - [ZIP file x86](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-darwin-x64-2.2.0.zip)
- Linux:
  ...
  - [Debian x64](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/business-studio_2.2.0_amd64.deb)
- Windows
  - [Executable x86](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-2.2.0.Setup.exe)
