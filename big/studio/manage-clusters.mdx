...
We strive to achieve a high performance in business intelligence. Our approach to cluster load balancing is one of the things that helps the cause. We work to ensure better alert balancing between connected Buinsess engines. 
