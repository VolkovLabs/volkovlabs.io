...
The **Overview** tab, in addition to the basic engine statistics such as version, status (ok/error), a number of alert rules and actions, features the Alert History and high availability state.
