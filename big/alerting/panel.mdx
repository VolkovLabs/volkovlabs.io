...
We target to have the Alert Management panel work with hundreds or even thousands of alerts with grouping and filtering to ensure easy navigation and control.
...
<Image
  title="Flow schema for the statuses change in the Business Engine."
...
- **Details**. Opens the drawer with the alert details. For the alert rules in the **Alerting** and **Error** statuses, adds the **Event Details** category with all necessary information for troubleshooting.
