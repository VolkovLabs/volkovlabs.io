...
Business Studio can be connected to one or all business engines within a cluster to configure alert rules, check data preview and evaluate alert history.
