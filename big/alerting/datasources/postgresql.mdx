...
5. The **Thresholds** section has many tiers:
        - below 30 (green area on the panel),
        - from 30 to 60 (blue area on the panel),
        - from 60 to 70 (yellow area on the panel),
        - from 70 to 80 (orange area on the panel),
        - above 80 (red area on the panel).
