...
Below is the general description of such a configuration. You can find the detailed [PostgreSQL](/big/alerting/datasources/postgresql/) and [Prometheuse](/big/alerting/datasources/prometheus/) examples in other parts of our documentation.
...
For only one device with the name **Tampe South 124**, the allowed range is below 30. Any value above 30 triggers the alert rule.
