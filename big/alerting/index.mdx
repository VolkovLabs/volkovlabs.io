...
Business Alerting is a module of Business Engine configured using Business Studio. The [Business Engine](../engine/) is resposible for executing the configuration you specified in the Business Studio.
