...
The **Data Preview** page highlights thresholds with Grafana’s color-coded clarity, making it easier to spot trigger conditions at a glance. To check it out:
